...
public class RenderedTextTests : IAsyncLifetime
{
    ...
    [InlineData("/pt/rentals/drive-scout-4")]
    [InlineData("/rentals/drive-wheelchair")]
    [InlineData("/rentals/single-stroller")]
    [InlineData("/pt/rentals/single-stroller")]
    [InlineData("/delivery-areas")]
    [InlineData("/pt/delivery-areas")]
    [InlineData("/pt/contact")]
    [InlineData("/pt/terms")]
    [InlineData("/pt/privacy")]
